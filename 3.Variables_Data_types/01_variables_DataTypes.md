...
```py
first_name, last_name, country, age, is_married = 'Python', 'Program', 'Helsink', 250, True
...
first_name = 'Python'     # str
last_name = 'Program'       # str
country = 'India'         # str
city= 'Hyderabad'            # str
...
2. Write a python comment saying 'Python programming'
