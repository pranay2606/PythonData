...
person_json = "{'name': 'Python', 'country': 'India', 'city': 'Hyderabad', 'skills': ['JavaScrip', 'React', 'Python']}"
...
# output
<class 'dict'>
{'name': 'Python', 'country': 'India', 'city': 'Hyderabad', 'skills': ['JavaScrip', 'React', 'Python']}
Python
```
...
"Python","India","Hyderabad","JavaScript"
```
...
Column names are :name, country, city, skills
        Python is a teacher. He lives in India, Hyderabad.
Number of lines:  2
```
...
6. Use the function, find_most_frequent_words to find:
   a) The ten most frequent words used in [Obama's speech File]
