...
print(full_name) # Python Program
...
print(challenge.expandtabs())   # '  days    of      python'
print(challenge.expandtabs(10)) # '    days      of        python'
```
...
print(sentence) # I am Python Program. I am 250 years old. I am a teacher. I live in India.
...
```py
challenge = 'days of pythoonnn'
print(challenge.strip('noth')) # ' days of py'
```
...
```py
challenge = 'Python'
print(challenge.replace('python', 'coding')) # ' days of coding'
```
...
```py
challenge = 'Python'
print(challenge.split()) # ['days', 'of', 'python']
challenge = 'days, of, python'
print(challenge.split(', ')) # ['days', 'of', 'python']
```
...
```py
challenge = 'Python'
print(challenge.swapcase())   # Python
challenge = 'Python'
print(challenge.swapcase())  # Python
```
...
```py
challenge = 'Python'
print(challenge.startswith('')) # True

challenge = '30 days of python'
print(challenge.startswith('')) # False
```
...
1. Concatenate the string 'Days', 'Of', 'Python' to a single string, 'Python'.
